...
Detecting such changes is therefore essential
for understanding the regulatory mechanisms underlying allopolyploid evolution and adaptation,
and the `r pkg("hespresso")` package provides a means
...
HOBIT accommodates a wide range of polyploid systems,
including those with uneven or complex subgenome compositions,
and supports comparisons across multiple conditions.
