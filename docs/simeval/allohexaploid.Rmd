...
```{r sim-3x-plotherdistr, fig.cap="Distribution of homeolog expression ratios for the first subgenome in a simulated allohexaploid across two groups.", fig.height=2.6}
x <- sim_homeolog_counts(n_subgenomes = 3)
...
```{r sim-3x-plotherdistr-base, fig.cap="Distribution of homeolog expression ratios for all subgenomes in a simulated allohexaploid across two groups.", fig.height=4.8}
